...
const CityDropdown = () => {
  ...
  const PropertyTypeDropdown = () => {
    const [selected, setSelected] = useState(propertyTypes[1])
  ...
  const PriceDropDown = () => {
    const [selected, setSelected] = useState(priceDropdowns[1])
  ...
  export { PropertyTypeDropdown, CityDropdown , PriceDropDown};